        ...
        <div className="space-y-4">
          ...
          {profile?.openai_api_key && (
            <div>
              ...
              <div className="px-4 py-3 glass rounded-xl text-white/60 font-mono text-sm">
                {profile.openai_api_key.slice(0, 4) +
                  "•".repeat(profile.openai_api_key.length - 8) +
                  profile.openai_api_key.slice(-4)}
              </div>
            </div>
          )}
          ...
          <div className="glass rounded-xl p-4">
            ...
            <p className="text-xs text-white/60 mb-3">
              Create an OpenAI API key to access models like GPT-4o and o3-mini.
            </p>
            <motion.a
