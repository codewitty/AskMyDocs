...
export function SettingsModal({ isOpen, onClose }: SettingsModalProps) {
  ...
  useEffect(() => {
    if ((profile as any)?.openai_api_key) {
      setApiKey((profile as any).openai_api_key);
    }
  }, [profile]);
          ...
          >
            ...
            >
              <div>
                ...
                >
                  <Shield size={12} />
                  Your API key is stored securely and only used for OpenAI
                  requests.
                </motion.p>
              </div>
                ...
                <div className="flex items-start gap-4 relative z-10">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/70 mb-4 leading-relaxed">
                      You need an OpenAI API key to use this chat application.
                    </p>
                    <motion.a
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {(profile as any)?.openai_api_key ? (
                        <span className="font-mono text-green-400">
                          {showApiKey
                            ? (profile as any).openai_api_key
                            : maskApiKey((profile as any).openai_api_key)}
                        </span>
                      ) : (
